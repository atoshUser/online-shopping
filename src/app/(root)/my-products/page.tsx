...
const MyProducts = () => {
  ...
  <>
   ...
   <div className='flex relative justify-center flex-col space-y-5 h-[350px]'>
   <h2 className='text-[18px] md:text-[25px] text-slate-400'>Products not found!</h2>
          <div className='h-full flex items-center justify-center'>
          <div className='w-24  h-24 border-2
           border-red-600  border-dotted animate-spin'/>
          </div>
          <Link href={'/'} className='myBtn  text-center rounded-md bg-white text-black font-medium'>
           Main page
          </Link>
   </div>
      </div>
